...
def get_notifications():
    if request.headers.get('Authorization'):
        ...
        notifications_query = "SELECT notifications.notification_id, notifications.object_id, notifications.type, launcher_user.names AS launcher_name, \
                                ...
                                branches.name AS newsfeed_activity, branches.company_id, branches.branch_id, notifications.read, \
                                notifications.notification_date,users_image.main_image AS user_image, friends.launcher_user_id AS launcher_friend \
                                FROM notifications \
