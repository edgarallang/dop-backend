...
def get_notifications():
    if request.headers.get('Authorization'):
        ...
        notifications_query = "SELECT notifications.notification_id,notifications.type, launcher_user.names AS "+"launcher_name"+",\
                                ...
                                branches.name AS "+"newsfeed_activity"+", notifications.read, notifications.notification_date,users_image.main_image AS "+"user_image"+", branches_design.logo AS "+"branch_image"+" FROM notifications\
                                ...
                                LEFT JOIN users_image ON friends.friends_id = users_image.user_id AND notifications.type= 'friend'\
                                LEFT JOIN branches_design ON branches.branch_id = branches_design.logo AND notifications.type= 'newsfeed'\
