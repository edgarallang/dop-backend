...
def get_problems():
    report_query = db.engine.execute("SELECT problems_report.*, users.names, users.surnames, users_session.email, branches.name as branch_name, coupons.name as coupon_name FROM FROM problems_report \
