...
def use_coupon():
    ...
    qr_code = 5 #request.json['qr_code']
    ...
    client_coupon = ClientsCoupon.query.join(Coupon, ClientsCoupon.coupon_id==Coupon.coupon_id).add_columns(ClientsCoupon.clients_coupon_id, Coupon.branch_id).filter(ClientsCoupon.clients_coupon_id==client_coupon_id)
